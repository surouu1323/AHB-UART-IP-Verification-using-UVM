class uart_full_duplex_ran_cfg_test extends uart_base_test;
  `uvm_component_utils(uart_full_duplex_ran_cfg_test)
  ...
  function new(string name="uart_full_duplex_ran_cfg_test", uvm_component parent);
