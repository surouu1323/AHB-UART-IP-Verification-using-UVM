class uart_half_rx_test extends uart_base_test;
  `uvm_component_utils(uart_half_rx_test)
  ...
  function new(string name="uart_half_rx_test", uvm_component parent);
  ...
  virtual task run_phase(uvm_phase phase); 
    ...
    uart_cfg.sampling_mode  = uart_configuration::M_13x;
   ...
   endtask
    ...
    /*=============  TEST START  ===============*/
            ...
            `uvm_info("UART_STATUS", $sformatf("<<< [CASE %0d] Start test.\n", test_case_cnt), UVM_LOW)
