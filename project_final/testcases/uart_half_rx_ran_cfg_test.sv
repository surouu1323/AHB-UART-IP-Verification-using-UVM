class uart_half_rx_ran_cfg_test extends uart_base_test;

  `uvm_component_utils(uart_half_rx_ran_cfg_test)
  ...
  function new(string name="uart_half_rx_ran_cfg_test", uvm_component parent);
